  ...
  return (
    <div className="home__data">
        <h1 className="home__title">
            Krish<span className='sub__name'>4Alex</span>
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">User Interface Designer</h3>
        <p className="home__description">I’m UI/UX designer in lucknow , and I’m  very passionate and dedicated to my work..</p>
